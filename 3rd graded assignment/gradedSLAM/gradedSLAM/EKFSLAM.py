    ...
    def update(
        ...
        if numLmk > 0:
            ...
            if za.shape[0] == 0:
                ...
                W = P @ H.T @ la.inv(S) # TODO, Kalman gain, can use S_cho_factors
                ...
                Pupd = jo @ P @ jo.T + W @ stackedNoise @ W.T # TODO, Kalman update. This is the main workload on VP after speedups
