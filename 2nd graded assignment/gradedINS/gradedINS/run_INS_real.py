...
# %% Measurement noise
# Continous noise
cont_gyro_noise_std = 4.36e-5  # TODO 4.36e-5  # (rad/s)/sqrt(Hz)
cont_acc_noise_std = 1.167e-3  # TODO (m/s**2)/sqrt(Hz)
...
# Bias values
rate_bias_driving_noise_std = 2.42e-6 # TODO
cont_rate_bias_driving_noise_std = rate_bias_driving_noise_std/np.sqrt(1/dt)

acc_bias_driving_noise_std = 5e-4 # TODO
